...
fn register_user(model : Json<GenericTokenViewModel<AdminCreateUserViewModel>>, sled_db : State<StoreManager>) -> JsonValue {
...
fn update_user(model : Json<GenericTokenViewModel<AdminUpdateUserViewModel>>, sled_db : State<StoreManager>) -> JsonValue {
...
fn delete_user(model : Json<GenericTokenViewModel<DeleteUserViewModel>>, sled_db : State<StoreManager>) -> JsonValue {
...
fn change_password(model : Json<GenericTokenViewModel<AdminChangePasswordUserViewModel>>, sled_db : State<StoreManager>) -> JsonValue {
